...
def test_suffix():
    ...
    assert suffix("functional", "optional") == "tional"
    assert suffix("action", "reaction") == "action"
    assert suffix("running", "ing") == "ing"
    assert suffix("DevelopMENT", "agreeMENT") == "ment"     
    assert suffix("testing", "testing") == "testing"
    assert suffix("adorable", "table") == "able"
    assert suffix("prefix", "suffix") == "fix"
